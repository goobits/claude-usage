#!/bin/bash
# Installation script for Claude Usage Analytics
# Installs Rust dependencies and builds the project
...
install_global() {
    ...
    cargo install "$PACKAGE_NAME" || {
        ...
        log_info "Try using: ./install.sh --dev for local development installation"
        return 1
    }
