...
mod keeper_tests {
    ...
    fn test_keeper_integration_parses_valid_jsonl() {
        let jsonl_content = r#"{"timestamp":"2024-01-15T10:30:00Z","message":{"id":"msg_123","model":"claude-3-5-sonnet-20241022","usage":{"input_tokens":100,"output_tokens":200,"cache_creation_input_tokens":0,"cache_read_input_tokens":50}},"costUSD":0.0045,"requestId":"req_456"}
{"timestamp":"2024-01-15T10:31:00Z","message":{"id":"msg_789","model":"claude-3-5-sonnet-20241022","usage":{"input_tokens":150,"output_tokens":250,"cache_creation_input_tokens":10,"cache_read_input_tokens":60}},"costUSD":0.0055,"requestId":"req_012"}"#;
        ...
        assert_eq!(entries[1].message.usage.as_ref().unwrap().output_tokens, 250);
    }

    #[test]
    fn test_keeper_integration_handles_malformed_lines() {
        let jsonl_content = r#"{"timestamp":"2024-01-15T10:30:00Z","message":{"id":"msg_valid","model":"claude-3-5-sonnet-20241022"},"requestId":"req_valid"}
...
null
undefined
{"timestamp":"2024-01-15T10:32:00Z","message":{"id":"msg_final","model":"claude-3-5-sonnet-20241022"},"requestId":"req_final"}"#;
        ...
        assert_eq!(entries.len(), 3, "Should parse 3 valid entries, skipping malformed lines");
    ...
    fn test_keeper_integration_handles_schema_variations() {
        ...
        let jsonl_content = r#"{"timestamp":"2024-01-15T10:30:00Z","message":{"id":"msg_1","model":"claude-3-5-sonnet-20241022"},"cost_usd":0.001,"requestId":"req_1"}
{"timestamp":"2024-01-15T10:31:00Z","message":{"id":"msg_2","model":"claude-3-5-sonnet-20241022"},"costUSD":0.002,"request_id":"req_2"}
{"timestamp":"2024-01-15T10:32:00Z","message":{"id":"msg_3","model":"claude-3-5-sonnet-20241022"},"cost":0.003,"request_id":"req_3"}"#;
    ...
    fn test_keeper_integration_handles_missing_fields() {
        ...
        let jsonl_content = r#"{"timestamp":"2024-01-15T10:30:00Z","message":{"id":"msg_no_usage","model":"claude-3-5-sonnet-20241022"},"requestId":"req_1"}
{"timestamp":"2024-01-15T10:31:00Z","message":{"id":"msg_no_cost","model":"claude-3-5-sonnet-20241022","usage":{"input_tokens":100,"output_tokens":200,"cache_creation_input_tokens":0,"cache_read_input_tokens":0}},"requestId":"req_2"}
{"timestamp":"2024-01-15T10:32:00Z","message":{"id":"msg_complete","model":"claude-3-5-sonnet-20241022","usage":{"input_tokens":150,"output_tokens":250,"cache_creation_input_tokens":10,"cache_read_input_tokens":20}},"costUSD":0.005,"requestId":"req_3"}"#;
    ...
    fn test_keeper_integration_large_token_values() {
        let jsonl_content = r#"{"timestamp":"2024-01-15T10:30:00Z","message":{"id":"msg_large","model":"claude-3-5-sonnet-20241022","usage":{"input_tokens":999999,"output_tokens":888888,"cache_creation_input_tokens":777777,"cache_read_input_tokens":666666}},"costUSD":123.456,"requestId":"req_large"}"#;
...
{"timestamp":"2024-01-15T10:32:00Z","message":{"id":"msg_3","model":"claude-3-opus-20240229","usage":{"input_tokens":200,"output_tokens":300,"cache_creation_input_tokens":0,"cache_read_input_tokens":0}},"costUSD":0.015,"requestId":"req_3"}"#;
...
{"timestamp":"2024-01-15T10:30:00.123Z","message":{"id":"msg_2","model":"claude-3-5-sonnet-20241022"},"requestId":"req_2"}
{"timestamp":"2024-01-15T10:30:00+00:00","message":{"id":"msg_3","model":"claude-3-5-sonnet-20241022"},"requestId":"req_3"}"#;
    ...
    fn test_keeper_integration_zero_values() {
        let jsonl_content = r#"{"timestamp":"2024-01-15T10:30:00Z","message":{"id":"msg_zero","model":"claude-3-5-sonnet-20241022","usage":{"input_tokens":0,"output_tokens":0,"cache_creation_input_tokens":0,"cache_read_input_tokens":0}},"costUSD":0.0,"requestId":"req_zero"}"#;
...
{"timestamp":"2024-01-15T10:32:00Z","message":null,"requestId":"req_3"}
{"timestamp":"2024-01-15T10:33:00Z","message":{"id":"msg_4","model":"claude-3-5-sonnet-20241022"},"requestId":"req_4"}"#;
    ...
    fn test_keeper_integration_various_request_id_formats() {
        let jsonl_content = r#"{"timestamp":"2024-01-15T10:30:00Z","message":{"id":"msg_1","model":"claude-3-5-sonnet-20241022"},"requestId":"req_abc123"}
{"timestamp":"2024-01-15T10:31:00Z","message":{"id":"msg_2","model":"claude-3-5-sonnet-20241022"},"request_id":"req_def456"}
{"timestamp":"2024-01-15T10:32:00Z","message":{"id":"msg_3","model":"claude-3-5-sonnet-20241022"},"requestId":"1234567890"}"#;
