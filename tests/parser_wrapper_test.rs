...
{"timestamp":"2025-01-15T10:31:00Z","message":{"id":"msg_2","model":"claude-3-5-sonnet-20241022"},"requestId":"req_2"}"#;
    ...
    assert_eq!(
        entries.len(),
        2,
        "Should parse 2 valid entries with keeper integration"
    );
}
...
fn test_unified_parser_keeper_feature_comprehensive() {
    let jsonl_content = r#"{"timestamp":"2025-01-15T10:30:00Z","message":{"id":"msg_valid1","model":"claude-3-5-sonnet-20241022","usage":{"input_tokens":100,"output_tokens":200,"cache_creation_input_tokens":5,"cache_read_input_tokens":10}},"costUSD":0.005,"requestId":"req_1"}
{this line should be skipped due to malformed json}
{"timestamp":"2025-01-15T10:31:00Z","message":{"id":"msg_valid2","model":"claude-3-haiku-20240307","usage":{"input_tokens":50,"output_tokens":100,"cache_creation_input_tokens":0,"cache_read_input_tokens":25}},"costUSD":0.002,"requestId":"req_2"}
null
{"timestamp":"2025-01-15T10:32:00Z","message":{"id":"msg_valid3","model":"claude-3-5-sonnet-20241022"},"requestId":"req_3"}"#;
    ...
    assert_eq!(
        entries.len(),
        3,
        "Should parse 3 valid entries with keeper integration"
    );
...
fn test_unified_parser_uses_legacy_when_disabled() {
    ...
    let jsonl_content = r#"{"timestamp":"2025-01-15T10:30:00Z","message":{"id":"msg_legacy","model":"claude-3-5-sonnet-20241022","usage":{"input_tokens":100,"output_tokens":200,"cache_creation_input_tokens":0,"cache_read_input_tokens":0}},"costUSD":0.005,"requestId":"req_legacy"}"#;
    ...
    match result {
        ...
        Err(_) => {
            ...
            assert!(
                true,
                "Legacy parser handled the file (with error is acceptable)"
            );
        }
    }
}
...
fn test_unified_parser_handles_single_entry() {
    let jsonl_content = r#"{"timestamp":"2025-01-15T10:30:00Z","message":{"id":"single_msg","model":"claude-3-5-sonnet-20241022","usage":{"input_tokens":75,"output_tokens":125,"cache_creation_input_tokens":0,"cache_read_input_tokens":0}},"costUSD":0.003,"requestId":"single_req"}"#;
...
{"timestamp":"2025-01-15T10:32:00Z","message":{"id":"msg_3","model":"claude-3-5-sonnet-20241022","usage":{"input_tokens":200,"output_tokens":300,"cache_creation_input_tokens":10,"cache_read_input_tokens":20}},"costUSD":0.008,"requestId":"req_3"}"#;
...
fn test_unified_parser_whitespace_handling() {
    let jsonl_content = r#"
{"timestamp":"2025-01-15T10:30:00Z","message":{"id":"msg_with_whitespace","model":"claude-3-5-sonnet-20241022"},"requestId":"req_ws"}

{"timestamp":"2025-01-15T10:31:00Z","message":{"id":"msg_after_blank","model":"claude-3-5-sonnet-20241022"},"requestId":"req_ab"}
"#;
    ...
    match result {
        Ok(entries) => {
            ...
            assert!(
                entries.len() >= 1,
                "Should parse at least one valid entry despite whitespace"
            );
        }
        Err(_) => {
