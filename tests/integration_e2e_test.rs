...
fn create_realistic_jsonl(path: &Path, num_entries: usize, include_malformed: bool) {
    ...
    for i in 0..num_entries {
        ...
        let entry = if i % 3 == 0 {
            ...
            format!(
                r#"{{"timestamp":"2025-01-15T10:30:{:02}Z","message":{{"id":"msg_{}","model":"claude-3-5-sonnet-20241022","usage":{{"input_tokens":{},"output_tokens":{},"cache_creation_input_tokens":{},"cache_read_input_tokens":{}}}}},"costUSD":{},"requestId":"req_{}"}}"#,
                i % 60,
                i,
                100 + i,
                200 + i,
            ...
            format!(
                r#"{{"timestamp":"2025-01-15T10:31:{:02}Z","message":{{"id":"msg_{}","model":"claude-3-opus-20240229","usage":{{"input_tokens":{},"output_tokens":{},"cache_creation_input_tokens":0,"cache_read_input_tokens":0}}}},"cost_usd":{},"request_id":"req_{}"}}"#,
                i % 60,
                i,
                150 + i,
                250 + i,
            ...
            format!(
                r#"{{"timestamp":"2025-01-15T10:32:{:02}Z","message":{{"id":"msg_{}","model":"claude-3-5-sonnet-20241022"}},"requestId":"req_{}"}}"#,
                i % 60,
                i,
                i
            )
...
async fn test_e2e_vm_exclusion() {
    ...
    let result_with_vms = analyzer
        .aggregate_data("daily", options_with_vms)
        .await
        .unwrap();
    ...
    let result_without_vms = analyzer
        .aggregate_data("daily", options_without_vms)
        .await
        .unwrap();
...
async fn test_e2e_date_filtering() {
    ...
    let options = ProcessOptions {
        ...
        until_date: Some(
            chrono::DateTime::parse_from_rfc3339("2024-01-16T23:59:59Z")
                .unwrap()
                .with_timezone(&chrono::Utc),
        ),
        snapshot: false,
